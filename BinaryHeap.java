...
public class BinaryHeap
{
	 ...
	 * @param position index of item to decrease the distance of 
	 * @param dist the amount to reduce the distance
	 */
	public void decreaseKey(int position, double dist)
	{
		Vertex x = array[position];
		x.distance = dist;	
		if( currentSize == array.length - 1 )
			enlargeArr( array.length * 2 + 1 );		
		int hole = ++currentSize;
