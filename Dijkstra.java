...
public class Dijkstra {
	...
	(double ux, double uy, double vx, double vy) {
		...
		// Returns the Euclidean distance corresponding to coordinates 
		// d = sqrt((ux-vx)^2 + (uy-vy)^2).
	...
	public void computeAllEuclideanDistances() {
		...
		// both vertices of an edge has reference to edge; 
		// hence, we update Euclidean distance twice per edge
